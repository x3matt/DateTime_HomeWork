...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(sortReformator(dateList));
	...
	public static List<String> reformator(List<String> dateList){
		return dateList
				...
				.map(a -> a.format(DateTimeFormatter.ofPattern("dd MMMM yyyy EEEE")))
				.collect(Collectors.toList());
	}
	public static List<String> sortReformator(List<String> dateList){
		return dateList
				.stream()
				.map(a -> LocalDate.parse(a))
				.sorted()
